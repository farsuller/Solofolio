...
object Constants {
    ...
    const val MAIN_INTRO = "\nSkilled and results-driven Android Developer with a talent for designing and coding diverse native and cross platform applications, " +
        "ensuring comprehensive testing in line with client specifications. \n\nWith over 7 years in Android Development and had some exposure to other " +
        "technologies. \n\nI possess a robust background in development, design, testing, and deployment. \n\nAlongside my expertise, I bring day-to-day exposure " +
        "to teamwork and collaborative development."
...
object Res {
    object Image {
        ...
        const val WORK_6 = "file:///android_asset/images/work_bcs_logo.jpg"
    }
    object Icon {
